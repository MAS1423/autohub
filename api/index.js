...
var users = (0, import_mysql_core.mysqlTable)("users", {
  ...
  whatsapp: (0, import_mysql_core.varchar)("whatsapp", { length: 30 }),
...
var dealers = (0, import_mysql_core.mysqlTable)("dealers", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  userId: (0, import_mysql_core.int)("userId"),
  name: (0, import_mysql_core.varchar)("name", { length: 200 }).notNull(),
  slug: (0, import_mysql_core.varchar)("slug", { length: 200 }).notNull().unique(),
  logo: (0, import_mysql_core.text)("logo"),
  cover: (0, import_mysql_core.text)("cover"),
  bio: (0, import_mysql_core.text)("bio"),
  phone: (0, import_mysql_core.varchar)("phone", { length: 30 }),
  whatsapp: (0, import_mysql_core.varchar)("whatsapp", { length: 30 }),
  email: (0, import_mysql_core.varchar)("email", { length: 200 }),
  city: (0, import_mysql_core.varchar)("city", { length: 100 }),
  neighborhood: (0, import_mysql_core.varchar)("neighborhood", { length: 100 }),
  lat: (0, import_mysql_core.float)("lat"),
  lng: (0, import_mysql_core.float)("lng"),
  address: (0, import_mysql_core.text)("address"),
  workingHours: (0, import_mysql_core.varchar)("workingHours", { length: 200 }),
  brands: (0, import_mysql_core.text)("brands"),
  isVerified: (0, import_mysql_core.boolean)("isVerified").default(false).notNull(),
  plan: (0, import_mysql_core.mysqlEnum)("plan", ["free", "basic", "pro", "premium"]).default("free").notNull(),
  commercialReg: (0, import_mysql_core.varchar)("commercialReg", { length: 100 }),
  dealerType: (0, import_mysql_core.mysqlEnum)("dealerType", ["sell", "buy", "both"]).default("sell").notNull(),
  views: (0, import_mysql_core.int)("views").default(0).notNull(),
  vehiclesCount: (0, import_mysql_core.int)("vehiclesCount").default(0).notNull(),
  createdAt: (0, import_mysql_core.timestamp)("createdAt").defaultNow().notNull(),
  updatedAt: (0, import_mysql_core.timestamp)("updatedAt").defaultNow().onUpdateNow().notNull(),
  // Social media & extra contact
  instagram: (0, import_mysql_core.varchar)("instagram", { length: 200 }),
  twitter: (0, import_mysql_core.varchar)("twitter", { length: 200 }),
  snapchat: (0, import_mysql_core.varchar)("snapchat", { length: 200 }),
  tiktok: (0, import_mysql_core.varchar)("tiktok", { length: 200 }),
  website: (0, import_mysql_core.varchar)("website", { length: 300 }),
  // Detailed working hours (JSON: { sat: "9-5", sun: "9-5", ... })
  workingHoursDetail: (0, import_mysql_core.text)("workingHoursDetail"),
  // Subscription dates
  planStartDate: (0, import_mysql_core.timestamp)("planStartDate"),
  planEndDate: (0, import_mysql_core.timestamp)("planEndDate"),
  stripeCustomerId: (0, import_mysql_core.varchar)("stripeCustomerId", { length: 100 }),
  stripeSubscriptionId: (0, import_mysql_core.varchar)("stripeSubscriptionId", { length: 100 }),
  // Rejection reason for admin
  rejectionReason: (0, import_mysql_core.text)("rejectionReason"),
  status: (0, import_mysql_core.mysqlEnum)("status", ["pending", "active", "suspended", "rejected"]).default("pending").notNull()
});
var vehicles = (0, import_mysql_core.mysqlTable)("vehicles", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  dealerId: (0, import_mysql_core.int)("dealerId").notNull(),
  brand: (0, import_mysql_core.varchar)("brand", { length: 100 }).notNull(),
  model: (0, import_mysql_core.varchar)("model", { length: 100 }).notNull(),
  bodyType: (0, import_mysql_core.varchar)("bodyType", { length: 80 }),
  trim: (0, import_mysql_core.varchar)("trim", { length: 100 }),
  year: (0, import_mysql_core.int)("year").notNull(),
  price: (0, import_mysql_core.int)("price").notNull(),
  condition: (0, import_mysql_core.mysqlEnum)("condition", ["new", "used"]).notNull(),
  fuelType: (0, import_mysql_core.mysqlEnum)("fuelType", ["petrol", "diesel", "hybrid", "electric"]).default("petrol").notNull(),
  transmission: (0, import_mysql_core.mysqlEnum)("transmission", ["automatic", "manual"]).default("automatic").notNull(),
  color: (0, import_mysql_core.varchar)("color", { length: 80 }),
  mileage: (0, import_mysql_core.int)("mileage").default(0).notNull(),
  description: (0, import_mysql_core.text)("description"),
  images: (0, import_mysql_core.text)("images"),
  city: (0, import_mysql_core.varchar)("city", { length: 100 }),
  videoUrl: (0, import_mysql_core.text)("videoUrl"),
  videoKey: (0, import_mysql_core.text)("videoKey"),
  status: (0, import_mysql_core.mysqlEnum)("status", ["available", "reserved", "sold"]).default("available").notNull(),
  views: (0, import_mysql_core.int)("views").default(0).notNull(),
  createdAt: (0, import_mysql_core.timestamp)("createdAt").defaultNow().notNull(),
  updatedAt: (0, import_mysql_core.timestamp)("updatedAt").defaultNow().onUpdateNow().notNull()
});
...
var inquiries = (0, import_mysql_core.mysqlTable)("inquiries", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  dealerId: (0, import_mysql_core.int)("dealerId").notNull(),
  vehicleId: (0, import_mysql_core.int)("vehicleId"),
  userId: (0, import_mysql_core.int)("userId"),
  name: (0, import_mysql_core.varchar)("name", { length: 200 }),
  phone: (0, import_mysql_core.varchar)("phone", { length: 30 }),
  message: (0, import_mysql_core.text)("message").notNull(),
  status: (0, import_mysql_core.mysqlEnum)("status", ["new", "read", "replied"]).default("new").notNull(),
  createdAt: (0, import_mysql_core.timestamp)("createdAt").defaultNow().notNull()
});
var contactMessages = (0, import_mysql_core.mysqlTable)("contact_messages", {
  ...
  name: (0, import_mysql_core.varchar)("name", { length: 200 }).notNull(),
  email: (0, import_mysql_core.varchar)("email", { length: 320 }),
  whatsapp: (0, import_mysql_core.varchar)("whatsapp", { length: 30 }).notNull(),
  message: (0, import_mysql_core.text)("message").notNull(),
  status: (0, import_mysql_core.mysqlEnum)("status", ["new", "read", "replied"]).default("new").notNull(),
  createdAt: (0, import_mysql_core.timestamp)("createdAt").defaultNow().notNull()
});
var vehicleRequests = (0, import_mysql_core.mysqlTable)("vehicle_requests", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  requestCode: (0, import_mysql_core.varchar)("requestCode", { length: 40 }).notNull().unique(),
  userId: (0, import_mysql_core.int)("userId").notNull(),
  name: (0, import_mysql_core.varchar)("name", { length: 200 }).notNull(),
  whatsapp: (0, import_mysql_core.varchar)("whatsapp", { length: 30 }).notNull(),
  email: (0, import_mysql_core.varchar)("email", { length: 320 }),
  ...
  bodyType: (0, import_mysql_core.varchar)("bodyType", { length: 80 }),
  models: (0, import_mysql_core.text)("models"),
  trim: (0, import_mysql_core.varchar)("trim", { length: 100 }),
  condition: (0, import_mysql_core.mysqlEnum)("condition", ["new", "used"]),
  minPrice: (0, import_mysql_core.int)("minPrice"),
  maxPrice: (0, import_mysql_core.int)("maxPrice"),
  targetPrice: (0, import_mysql_core.int)("targetPrice"),
  minYear: (0, import_mysql_core.int)("minYear"),
  message: (0, import_mysql_core.text)("message").notNull(),
  matchedDealers: (0, import_mysql_core.int)("matchedDealers").default(0).notNull(),
  status: (0, import_mysql_core.mysqlEnum)("status", ["submitted", "distributed", "closed"]).default("submitted").notNull(),
  createdAt: (0, import_mysql_core.timestamp)("createdAt").defaultNow().notNull()
});
var mediaUploads = (0, import_mysql_core.mysqlTable)("media_uploads", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  dealerId: (0, import_mysql_core.int)("dealerId").notNull(),
  vehicleId: (0, import_mysql_core.int)("vehicleId"),
  fileKey: (0, import_mysql_core.text)("fileKey").notNull(),
  fileUrl: (0, import_mysql_core.text)("fileUrl").notNull(),
  fileType: (0, import_mysql_core.mysqlEnum)("fileType", ["image", "video", "logo", "cover"]).notNull(),
  mimeType: (0, import_mysql_core.varchar)("mimeType", { length: 100 }),
  originalName: (0, import_mysql_core.varchar)("originalName", { length: 255 }),
  sizeBytes: (0, import_mysql_core.int)("sizeBytes"),
  createdAt: (0, import_mysql_core.timestamp)("createdAt").defaultNow().notNull()
});
var dealerStats = (0, import_mysql_core.mysqlTable)("dealer_stats", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  dealerId: (0, import_mysql_core.int)("dealerId").notNull(),
  date: (0, import_mysql_core.varchar)("date", { length: 10 }).notNull(),
  views: (0, import_mysql_core.int)("views").default(0).notNull(),
  inquiries: (0, import_mysql_core.int)("inquiries").default(0).notNull(),
  vehicleViews: (0, import_mysql_core.int)("vehicleViews").default(0).notNull()
});
var notifications = (0, import_mysql_core.mysqlTable)("notifications", {
  id: (0, import_mysql_core.int)("id").autoincrement().primaryKey(),
  userId: (0, import_mysql_core.int)("userId").notNull(),
  dealerId: (0, import_mysql_core.int)("dealerId"),
  type: (0, import_mysql_core.mysqlEnum)("type", ["inquiry", "review", "system", "approval"]).notNull(),
...
function localDataPath() {
  return import_node_path.default.resolve(process.cwd(), process.env.LOCAL_DATA_FILE ?? "data/autohub.local.json");
}
...
async function persist(state2) {
  ...
  saveQueue = saveQueue.then(async () => {
    ...
    await (0, import_promises.writeFile)(temporaryPath, `${JSON.stringify(state2, null, 2)}
`, "utf8");
...
async function createDefaultState() {
  ...
  const [adminPassword, dealerPassword, userPassword] = await Promise.all([
    (0, import_bcryptjs.hash)("admin123", 10),
    (0, import_bcryptjs.hash)("dealer123", 10),
    (0, import_bcryptjs.hash)("user123", 10)
  ]);
  const users2 = [
    {
      id: 1,
...
function createDatabasePool() {
  ...
  return (0, import_promise.createPool)({
    host: url.hostname,
...
function createDrizzleDatabase() {
  ...
  return (0, import_mysql2.drizzle)({ client: pool });
}
var database = null;
...
async function getUserByOpenId(openId) {
  ...
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(users).where((0, import_drizzle_orm.eq)(users.openId, openId)).limit(1);
  return rows[0];
}
async function getUserByEmail(email) {
  ...
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(users).where((0, import_drizzle_orm.eq)(users.email, email)).limit(1);
  return rows[0];
}
async function getUserByWhatsapp(whatsapp) {
  ...
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(users).where((0, import_drizzle_orm.eq)(users.whatsapp, whatsapp)).limit(1);
  return rows[0];
}
async function updateUserName(id, name) {
  ...
  await db.update(users).set({ name }).where((0, import_drizzle_orm.eq)(users.id, id));
}
async function updateUserProfile(id, data) {
  ...
  return getUserByOpenId((await db.select({ openId: users.openId }).from(users).where((0, import_drizzle_orm.eq)(users.id, id)).limit(1))[0]?.openId ?? "");
}
async function getAllUsers(limit = 200) {
  if (isLocalDataMode()) return localListUsers(limit);
  const db = await getDb();
  if (!db) return [];
  return db.select().from(users).orderBy((0, import_drizzle_orm.desc)(users.createdAt)).limit(limit);
}
...
async function getDealers(options = {}) {
  ...
  if (!db) return [];
  const conditions = [];
  if (options.city) conditions.push((0, import_drizzle_orm.eq)(dealers.city, options.city));
  if (options.brand) conditions.push((0, import_drizzle_orm.like)(dealers.brands, `%${options.brand}%`));
  if (options.q) conditions.push((0, import_drizzle_orm.like)(dealers.name, `%${options.q}%`));
  if (options.verified) {
    conditions.push((0, import_drizzle_orm.eq)(dealers.isVerified, true));
    conditions.push((0, import_drizzle_orm.eq)(dealers.status, "active"));
  }
  if (options.dealerType && options.dealerType !== "all") {
    conditions.push((0, import_drizzle_orm.or)((0, import_drizzle_orm.eq)(dealers.dealerType, options.dealerType), (0, import_drizzle_orm.eq)(dealers.dealerType, "both")));
  }
  return db.select().from(dealers).where(conditions.length ? (0, import_drizzle_orm.and)(...conditions) : void 0).orderBy((0, import_drizzle_orm.desc)(dealers.plan), (0, import_drizzle_orm.desc)(dealers.views)).limit(options.limit ?? 50).offset(options.offset ?? 0);
}
async function getDealerBySlug(slug) {
  if (isLocalDataMode()) return localGetDealerBySlug(slug);
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(dealers).where((0, import_drizzle_orm.eq)(dealers.slug, slug)).limit(1);
  return rows[0];
}
async function getDealerById(id) {
  ...
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(dealers).where((0, import_drizzle_orm.eq)(dealers.id, id)).limit(1);
  return rows[0];
}
...
async function updateDealer(id, data) {
  ...
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.update(dealers).set(data).where((0, import_drizzle_orm.eq)(dealers.id, id));
}
async function updateDealerViews(id) {
  if (isLocalDataMode()) return localUpdateDealerViews(id);
  const db = await getDb();
  if (!db) return;
  await db.update(dealers).set({ views: import_drizzle_orm.sql`${dealers.views} + 1` }).where((0, import_drizzle_orm.eq)(dealers.id, id));
}
async function updateDealerStatus(id, status, rejectionReason) {
  ...
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.update(dealers).set({ status, rejectionReason, isVerified: status === "active" }).where((0, import_drizzle_orm.eq)(dealers.id, id));
}
async function deleteDealer(id) {
  if (isLocalDataMode()) return localDeleteDealer(id);
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.delete(dealers).where((0, import_drizzle_orm.eq)(dealers.id, id));
}
async function getDealerOwnerUserId(id) {
  if (isLocalDataMode()) return localGetDealerOwnerUserId(id);
  const db = await getDb();
  if (!db) return null;
  const rows = await db.select({ userId: dealers.userId }).from(dealers).where((0, import_drizzle_orm.eq)(dealers.id, id)).limit(1);
...
async function getDealerByUserId(userId) {
  ...
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(dealers).where((0, import_drizzle_orm.eq)(dealers.userId, userId)).limit(1);
  return rows[0];
}
async function getAllDealersAdmin() {
  ...
  }).from(dealers).leftJoin(users, (0, import_drizzle_orm.eq)(dealers.userId, users.id)).orderBy((0, import_drizzle_orm.desc)(dealers.createdAt));
}
async function verifyDealer(id, isVerified) {
  if (isLocalDataMode()) return localVerifyDealer(id, isVerified);
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.update(dealers).set({ isVerified }).where((0, import_drizzle_orm.eq)(dealers.id, id));
}
async function updateDealerPlan(id, plan) {
  if (isLocalDataMode()) return localUpdateDealerPlan(id, plan);
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.update(dealers).set({ plan }).where((0, import_drizzle_orm.eq)(dealers.id, id));
}
async function getAdminStatsExtended() {
  ...
  if (!db) return base;
  const [dealerCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(dealers);
  const [verifiedCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(dealers).where((0, import_drizzle_orm.eq)(dealers.isVerified, true));
  const [pendingCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(dealers).where((0, import_drizzle_orm.eq)(dealers.isVerified, false));
  const [vehicleCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(vehicles);
  const [inquiryCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(inquiries);
  const [userCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(users);
  const [freeCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(dealers).where((0, import_drizzle_orm.eq)(dealers.plan, "free"));
  const [proCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(dealers).where((0, import_drizzle_orm.eq)(dealers.plan, "pro"));
  const [premiumCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(dealers).where((0, import_drizzle_orm.eq)(dealers.plan, "premium"));
  const [reviewCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(reviews);
  const [viewsSum] = await db.select({ total: import_drizzle_orm.sql`COALESCE(SUM(views), 0)` }).from(dealers);
  return {
...
async function getVehicles(options = {}) {
  ...
  if (!db) return [];
  const conditions = [];
  if (options.dealerId) conditions.push((0, import_drizzle_orm.eq)(vehicles.dealerId, options.dealerId));
  if (options.condition) conditions.push((0, import_drizzle_orm.eq)(vehicles.condition, options.condition));
  if (options.brand) conditions.push((0, import_drizzle_orm.eq)(vehicles.brand, options.brand));
  if (options.models?.length) conditions.push((0, import_drizzle_orm.or)(...options.models.map((model) => (0, import_drizzle_orm.like)(vehicles.model, `%${model}%`))));
  else if (options.model) conditions.push((0, import_drizzle_orm.like)(vehicles.model, `%${options.model}%`));
  if (options.bodyType) conditions.push((0, import_drizzle_orm.eq)(vehicles.bodyType, options.bodyType));
  if (options.trim) conditions.push((0, import_drizzle_orm.like)(vehicles.trim, `%${options.trim}%`));
  if (options.city) conditions.push((0, import_drizzle_orm.eq)(vehicles.city, options.city));
  if (options.minPrice !== void 0) conditions.push((0, import_drizzle_orm.gte)(vehicles.price, options.minPrice));
  if (options.maxPrice !== void 0) conditions.push((0, import_drizzle_orm.lte)(vehicles.price, options.maxPrice));
  if (options.minYear !== void 0) conditions.push((0, import_drizzle_orm.gte)(vehicles.year, options.minYear));
  if (options.maxYear !== void 0) conditions.push((0, import_drizzle_orm.lte)(vehicles.year, options.maxYear));
  if (options.fuelType) conditions.push((0, import_drizzle_orm.eq)(vehicles.fuelType, options.fuelType));
  if (options.transmission) conditions.push((0, import_drizzle_orm.eq)(vehicles.transmission, options.transmission));
  if (options.status) conditions.push((0, import_drizzle_orm.eq)(vehicles.status, options.status));
  if (options.q) conditions.push((0, import_drizzle_orm.or)(
    (0, import_drizzle_orm.like)(vehicles.brand, `%${options.q}%`),
    (0, import_drizzle_orm.like)(vehicles.model, `%${options.q}%`),
    (0, import_drizzle_orm.like)(vehicles.bodyType, `%${options.q}%`),
    (0, import_drizzle_orm.like)(vehicles.trim, `%${options.q}%`)
  ));
  if (!options.status) conditions.push((0, import_drizzle_orm.ne)(vehicles.status, "sold"));
  return db.select().from(vehicles).where(conditions.length ? (0, import_drizzle_orm.and)(...conditions) : void 0).orderBy((0, import_drizzle_orm.desc)(vehicles.createdAt)).limit(options.limit ?? 50).offset(options.offset ?? 0);
}
async function getVehiclesWithDealer(options = {}) {
  ...
  if (options.bodyType) conditions.push((0, import_drizzle_orm.eq)(vehicles.bodyType, options.bodyType));
  if (options.trim) conditions.push((0, import_drizzle_orm.like)(vehicles.trim, `%${options.trim}%`));
  if (options.city) conditions.push((0, import_drizzle_orm.or)((0, import_drizzle_orm.eq)(vehicles.city, options.city), (0, import_drizzle_orm.eq)(dealers.city, options.city)));
  if (options.minPrice !== void 0) conditions.push((0, import_drizzle_orm.gte)(vehicles.price, options.minPrice));
  if (options.maxPrice !== void 0) conditions.push((0, import_drizzle_orm.lte)(vehicles.price, options.maxPrice));
  if (options.minYear !== void 0) conditions.push((0, import_drizzle_orm.gte)(vehicles.year, options.minYear));
  if (options.maxYear !== void 0) conditions.push((0, import_drizzle_orm.lte)(vehicles.year, options.maxYear));
  ...
  }).from(vehicles).leftJoin(dealers, (0, import_drizzle_orm.eq)(vehicles.dealerId, dealers.id)).where(conditions.length ? (0, import_drizzle_orm.and)(...conditions) : void 0).orderBy((0, import_drizzle_orm.desc)(vehicles.createdAt)).limit(options.limit ?? 50).offset(options.offset ?? 0);
}
async function getVehicleById(id) {
  if (isLocalDataMode()) return localGetVehicleById(id);
  const db = await getDb();
  if (!db) return void 0;
  const rows = await db.select().from(vehicles).where((0, import_drizzle_orm.eq)(vehicles.id, id)).limit(1);
  return rows[0];
}
async function getVehicleWithDealer(id) {
  ...
  }).from(vehicles).leftJoin(dealers, (0, import_drizzle_orm.eq)(vehicles.dealerId, dealers.id)).where((0, import_drizzle_orm.eq)(vehicles.id, id)).limit(1);
  return rows[0];
}
...
async function updateVehicle(id, data) {
  ...
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.update(vehicles).set(data).where((0, import_drizzle_orm.eq)(vehicles.id, id));
}
async function deleteVehicle(id) {
  if (isLocalDataMode()) return localDeleteVehicle(id);
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.delete(vehicles).where((0, import_drizzle_orm.eq)(vehicles.id, id));
}
async function updateVehicleViews(id) {
  if (isLocalDataMode()) return localUpdateVehicleViews(id);
  const db = await getDb();
  if (!db) return;
  await db.update(vehicles).set({ views: import_drizzle_orm.sql`${vehicles.views} + 1` }).where((0, import_drizzle_orm.eq)(vehicles.id, id));
}
async function getReviewsByDealer(dealerId) {
  ...
  return db.select({
    ...
    userName: users.name
  }).from(reviews).leftJoin(users, (0, import_drizzle_orm.eq)(reviews.userId, users.id)).where((0, import_drizzle_orm.eq)(reviews.dealerId, dealerId)).orderBy((0, import_drizzle_orm.desc)(reviews.createdAt));
}
...
async function getDealerRating(dealerId) {
  ...
  const rows = await db.select({ avg: import_drizzle_orm.sql`AVG(${reviews.rating})`, count: import_drizzle_orm.sql`COUNT(*)` }).from(reviews).where((0, import_drizzle_orm.eq)(reviews.dealerId, dealerId));
...
async function hasUserReviewed(dealerId, userId) {
  ...
  const db = await getDb();
  if (!db) return false;
  const rows = await db.select({ id: reviews.id }).from(reviews).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(reviews.dealerId, dealerId), (0, import_drizzle_orm.eq)(reviews.userId, userId))).limit(1);
...
async function deleteReview(id) {
  ...
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.delete(reviews).where((0, import_drizzle_orm.eq)(reviews.id, id));
}
async function getAllReviewsAdmin() {
  ...
  return db.select({
    ...
    dealerName: dealers.name,
    userName: users.name
  }).from(reviews).leftJoin(dealers, (0, import_drizzle_orm.eq)(reviews.dealerId, dealers.id)).leftJoin(users, (0, import_drizzle_orm.eq)(reviews.userId, users.id)).orderBy((0, import_drizzle_orm.desc)(reviews.createdAt)).limit(500);
}
...
async function getVehicleRequestsByUser(userId) {
  ...
  const db = await getDb();
  if (!db) return [];
  return db.select().from(vehicleRequests).where((0, import_drizzle_orm.eq)(vehicleRequests.userId, userId)).orderBy((0, import_drizzle_orm.desc)(vehicleRequests.createdAt));
}
async function getAllVehicleRequestsAdmin() {
  ...
  }).from(vehicleRequests).leftJoin(users, (0, import_drizzle_orm.eq)(vehicleRequests.userId, users.id)).orderBy((0, import_drizzle_orm.desc)(vehicleRequests.createdAt)).limit(500);
}
async function getInquiriesByDealer(dealerId) {
  if (isLocalDataMode()) return localGetInquiriesByDealer(dealerId);
  const db = await getDb();
  if (!db) return [];
  return db.select().from(inquiries).where((0, import_drizzle_orm.eq)(inquiries.dealerId, dealerId)).orderBy((0, import_drizzle_orm.desc)(inquiries.createdAt));
}
async function updateInquiryStatus(id, status) {
  if (isLocalDataMode()) return localUpdateInquiryStatus(id, status);
  const db = await getDb();
  if (!db) throw new Error("Database not available");
  await db.update(inquiries).set({ status }).where((0, import_drizzle_orm.eq)(inquiries.id, id));
}
async function getAllInquiriesAdmin() {
  ...
  return db.select({
    ...
    dealerName: dealers.name
  }).from(inquiries).leftJoin(dealers, (0, import_drizzle_orm.eq)(inquiries.dealerId, dealers.id)).orderBy((0, import_drizzle_orm.desc)(inquiries.createdAt)).limit(200);
}
...
async function getAllContactMessagesAdmin() {
  ...
  const db = await getDb();
  if (!db) return [];
  return db.select().from(contactMessages).orderBy((0, import_drizzle_orm.desc)(contactMessages.createdAt)).limit(500);
}
...
async function getDealerDashboard(dealerId) {
  ...
  const [dealer] = await db.select().from(dealers).where((0, import_drizzle_orm.eq)(dealers.id, dealerId)).limit(1);
  const [rating] = await db.select({ avg: import_drizzle_orm.sql`AVG(${reviews.rating})`, count: import_drizzle_orm.sql`COUNT(*)` }).from(reviews).where((0, import_drizzle_orm.eq)(reviews.dealerId, dealerId));
  const [inquiryCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(inquiries).where((0, import_drizzle_orm.eq)(inquiries.dealerId, dealerId));
  const [vehicleCount] = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(vehicles).where((0, import_drizzle_orm.eq)(vehicles.dealerId, dealerId));
  const recentInquiries = await db.select().from(inquiries).where((0, import_drizzle_orm.eq)(inquiries.dealerId, dealerId)).orderBy((0, import_drizzle_orm.desc)(inquiries.createdAt)).limit(10);
  const recentVehicles = await db.select().from(vehicles).where((0, import_drizzle_orm.eq)(vehicles.dealerId, dealerId)).orderBy((0, import_drizzle_orm.desc)(vehicles.createdAt)).limit(6);
  return {
    totalViews: dealer?.views ?? 0,
    totalInquiries: Number(inquiryCount?.count ?? 0),
    totalVehicles: Number(vehicleCount?.count ?? 0),
...
async function getVehicleCountByDealer(dealerId) {
  ...
  const db = await getDb();
  if (!db) return 0;
  const rows = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(vehicles).where((0, import_drizzle_orm.eq)(vehicles.dealerId, dealerId));
...
async function getDealerAnalytics(dealerId, days = 30) {
  ...
  start.setDate(start.getDate() - days + 1);
  const startString = start.toISOString().slice(0, 10);
  const daily = await db.select().from(dealerStats).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(dealerStats.dealerId, dealerId), (0, import_drizzle_orm.gte)(dealerStats.date, startString))).orderBy(dealerStats.date);
  const totals = daily.reduce((total, row) => ({
...
async function recordDealerStat(dealerId, field) {
  ...
  const [existing] = await db.select().from(dealerStats).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(dealerStats.dealerId, dealerId), (0, import_drizzle_orm.eq)(dealerStats.date, date))).limit(1);
  if (existing) {
    const increment = field === "views" ? { views: import_drizzle_orm.sql`${dealerStats.views} + 1` } : field === "inquiries" ? { inquiries: import_drizzle_orm.sql`${dealerStats.inquiries} + 1` } : { vehicleViews: import_drizzle_orm.sql`${dealerStats.vehicleViews} + 1` };
    await db.update(dealerStats).set(increment).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(dealerStats.dealerId, dealerId), (0, import_drizzle_orm.eq)(dealerStats.date, date)));
  } else {
...
async function markNotificationsRead(userId, ids) {
  ...
  if (!db) return;
  if (ids?.length) {
    await db.update(notifications).set({ isRead: true }).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(notifications.userId, userId), import_drizzle_orm.sql`${notifications.id} IN (${ids.join(",")})`));
  } else {
    await db.update(notifications).set({ isRead: true }).where((0, import_drizzle_orm.eq)(notifications.userId, userId));
  }
}
async function getUnreadNotificationCount(userId) {
  ...
  const db = await getDb();
  if (!db) return 0;
  const rows = await db.select({ count: import_drizzle_orm.sql`COUNT(*)` }).from(notifications).where((0, import_drizzle_orm.and)((0, import_drizzle_orm.eq)(notifications.userId, userId), (0, import_drizzle_orm.eq)(notifications.isRead, false)));
  return Number(rows[0]?.count ?? 0);
}
...
var sdk = {
  ...
  async createSessionToken(openId, opts) {
    return new import_jose.SignJWT({ openId, name: opts.name }).setProtectedHeader({ alg: "HS256", typ: "JWT" }).setIssuedAt().setExpirationTime(Math.floor((Date.now() + opts.expiresInMs) / 1e3)).sign(getSecret());
  },
  /** Verify a JWT and return openId, or null. */
  async verifySessionToken(token) {
    try {
      const { payload } = await (0, import_jose.jwtVerify)(token, getSecret(), { algorithms: ["HS256"] });
...
function registerOAuthRoutes(app2) {
  ...
  app2.post("/api/auth/register", async (req, res) => {
    try {
      ...
      const passwordHash = await (0, import_bcryptjs2.hash)(password, ENV.passwordHashRounds);
  ...
  app2.post("/api/auth/login", async (req, res) => {
    try {
      ...
      const valid = await (0, import_bcryptjs2.compare)(password, user.passwordHash);
      if (!valid) {
        res.status(401).json({ error: "Invalid email or password" });
        return;
      }
...
function getUploadDir() {
  const dir = import_path.default.resolve(ENV.uploadDir);
...
function getObjectStorageClient() {
  ...
  if (!objectStorageClient) {
    objectStorageClient = new import_client_s3.S3Client({
      region: ENV.s3Region,
...
async function storagePut(relKey, data, contentType = "application/octet-stream") {
  ...
  if (storageUsesObjectStorage()) {
    ...
    await getObjectStorageClient().send(new import_client_s3.PutObjectCommand({
      Bucket: ENV.s3Bucket,
      Key: key,
  ...
  const filePath = import_path.default.join(uploadDir, uniqueKey);
  ...
  import_fs.default.writeFileSync(filePath, typeof data === "string" ? Buffer.from(data) : Buffer.from(data));
...
async function storageCreateUploadUrl(relKey, contentType) {
  ...
  const command = new import_client_s3.PutObjectCommand({ Bucket: ENV.s3Bucket, Key: key, ContentType: contentType });
  const uploadUrl = await (0, import_s3_request_presigner.getSignedUrl)(getObjectStorageClient(), command, { expiresIn: ENV.s3SignedUploadExpiresIn });
...
async function storageInspectObject(relKey) {
  ...
  const key = normalizeKey(relKey);
  const response = await getObjectStorageClient().send(new import_client_s3.HeadObjectCommand({ Bucket: ENV.s3Bucket, Key: key }));
...
function registerStorageProxy(app2) {
  ...
  const serveFile = async (req, res, key) => {
    ...
    const uploadDir = import_path2.default.resolve(ENV.uploadDir);
    const filePath = import_path2.default.resolve(uploadDir, key);
...
async function requireDealerAccess(user, dealerId) {
  ...
  if (!dealer) throw new import_server2.TRPCError({ code: "NOT_FOUND", message: "\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0645\u0639\u0631\u0636" });
  if (user.role === "admin") return dealer;
  const ownedDealer = await getDealerByUserId(user.id);
  if (!ownedDealer || ownedDealer.id !== dealerId) {
    throw new import_server2.TRPCError({ code: "FORBIDDEN", message: "\u0644\u064A\u0633 \u0644\u062F\u064A\u0643 \u0635\u0644\u0627\u062D\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0628\u064A\u0627\u0646\u0627\u062A \u0647\u0630\u0627 \u0627\u0644\u0645\u0639\u0631\u0636" });
  }
  return dealer;
}
async function requireVehicleAccess(user, vehicleId) {
  const vehicle = await getVehicleById(vehicleId);
  if (!vehicle) throw new import_server2.TRPCError({ code: "NOT_FOUND", message: "\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0639\u062B\u0648\u0631 \u0639\u0644\u0649 \u0627\u0644\u0633\u064A\u0627\u0631\u0629" });
...
var appRouter = router({
  ...
  auth: router({
    ...
    updateProfile: protectedProcedure.input(import_zod2.z.object({
      name: import_zod2.z.string().trim().min(2).max(120),
      whatsapp: import_zod2.z.string().trim().min(9).max(30),
      email: import_zod2.z.string().trim().email().optional().or(import_zod2.z.literal(""))
  ...
  dealers: router({
    list: publicProcedure.input(import_zod2.z.object({
      ...
      brand: import_zod2.z.string().optional(),
      q: import_zod2.z.string().optional(),
      verified: import_zod2.z.boolean().optional(),
      dealerType: import_zod2.z.string().optional(),
    ...
    bySlug: publicProcedure.input(import_zod2.z.object({ slug: import_zod2.z.string() })).query(async ({ input }) => {
    ...
    register: publicProcedure.input(import_zod2.z.object({
      ...
      ownerName: import_zod2.z.string().min(2),
      phone: import_zod2.z.string().min(9),
      email: import_zod2.z.string().email().optional(),
      city: import_zod2.z.string().min(1),
      neighborhood: import_zod2.z.string().optional(),
      brands: import_zod2.z.array(import_zod2.z.string()).min(1),
      bio: import_zod2.z.string().optional(),
      commercialReg: import_zod2.z.string().optional(),
      dealerType: import_zod2.z.enum(["sell", "buy", "both"]).default("sell")
    })).mutation(async ({ input, ctx }) => {
  ...
  vehicles: router({
    list: publicProcedure.input(import_zod2.z.object({
      dealerId: import_zod2.z.number().optional(),
      condition: import_zod2.z.enum(["new", "used"]).optional(),
      brand: import_zod2.z.string().optional(),
      model: import_zod2.z.string().optional(),
      models: import_zod2.z.array(import_zod2.z.string().min(1)).max(8).optional(),
      bodyType: import_zod2.z.string().optional(),
      trim: import_zod2.z.string().optional(),
      city: import_zod2.z.string().optional(),
      minPrice: import_zod2.z.number().optional(),
      maxPrice: import_zod2.z.number().optional(),
      minYear: import_zod2.z.number().optional(),
      maxYear: import_zod2.z.number().optional(),
      fuelType: import_zod2.z.string().optional(),
      transmission: import_zod2.z.string().optional(),
    ...
    search: publicProcedure.input(import_zod2.z.object({
      q: import_zod2.z.string().optional(),
      brand: import_zod2.z.string().optional(),
      model: import_zod2.z.string().optional(),
      models: import_zod2.z.array(import_zod2.z.string().min(1)).max(8).optional(),
      ...
      fuelType: import_zod2.z.string().optional(),
      transmission: import_zod2.z.string().optional(),
      limit: import_zod2.z.number().default(24),
      offset: import_zod2.z.number().default(0)
    }).optional()).query(async ({ input }) => getVehiclesWithDealer(input ?? {})),
    byId: publicProcedure.input(import_zod2.z.object({ id: import_zod2.z.number() })).query(async ({ input }) => {
    ...
    create: protectedProcedure.input(import_zod2.z.object({
      ...
      condition: import_zod2.z.enum(["new", "used"]),
      fuelType: import_zod2.z.enum(["petrol", "diesel", "hybrid", "electric"]).default("petrol"),
      transmission: import_zod2.z.enum(["automatic", "manual"]).default("automatic"),
      color: import_zod2.z.string().optional(),
      mileage: import_zod2.z.number().default(0),
      description: import_zod2.z.string().optional(),
      images: import_zod2.z.array(import_zod2.z.string()).default([]),
      videoUrl: import_zod2.z.string().optional(),
      videoKey: import_zod2.z.string().optional(),
      city: import_zod2.z.string().optional()
    })).mutation(async ({ input, ctx }) => {
    ...
    update: protectedProcedure.input(import_zod2.z.object({
      ...
      condition: import_zod2.z.enum(["new", "used"]).optional(),
      fuelType: import_zod2.z.enum(["petrol", "diesel", "hybrid", "electric"]).optional(),
      transmission: import_zod2.z.enum(["automatic", "manual"]).optional(),
      color: import_zod2.z.string().optional(),
      mileage: import_zod2.z.number().optional(),
      description: import_zod2.z.string().optional(),
      images: import_zod2.z.array(import_zod2.z.string()).optional(),
      videoUrl: import_zod2.z.string().optional(),
      videoKey: import_zod2.z.string().optional(),
      status: import_zod2.z.enum(["available", "reserved", "sold"]).optional(),
      city: import_zod2.z.string().optional()
    })).mutation(async ({ input, ctx }) => {
    ...
    delete: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number() })).mutation(async ({ input, ctx }) => {
  ...
  reviews: router({
    byDealer: publicProcedure.input(import_zod2.z.object({ dealerId: import_zod2.z.number() })).query(async ({ input }) => {
    ...
    create: protectedProcedure.input(import_zod2.z.object({
      ...
      comment: import_zod2.z.string().max(1e3).optional()
    })).mutation(async ({ input, ctx }) => {
  ...
  inquiries: router({
    create: publicProcedure.input(import_zod2.z.object({
      dealerId: import_zod2.z.number(),
      vehicleId: import_zod2.z.number().optional(),
      name: import_zod2.z.string().min(2),
      phone: import_zod2.z.string().min(9),
      message: import_zod2.z.string().min(5)
    })).mutation(async ({ input, ctx }) => {
      await createInquiry({
        dealerId: input.dealerId,
        vehicleId: input.vehicleId ?? null,
...
\u{1F4AC} ${input.message}`
    ...
    byDealer: protectedProcedure.input(import_zod2.z.object({ dealerId: import_zod2.z.number() })).query(async ({ input, ctx }) => {
      await requireDealerAccess(ctx.user, input.dealerId);
      return getInquiriesByDealer(input.dealerId);
    }),
    updateStatus: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number(), status: import_zod2.z.enum(["new", "read", "replied"]) })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") {
  ...
  contact: router({
    send: publicProcedure.input(import_zod2.z.object({
      name: import_zod2.z.string().trim().min(2, "\u0627\u0644\u0627\u0633\u0645 \u064A\u062C\u0628 \u0623\u0646 \u064A\u062D\u062A\u0648\u064A \u0639\u0644\u0649 \u062D\u0631\u0641\u064A\u0646 \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644").max(200),
      whatsapp: import_zod2.z.string().trim().min(9, "\u0631\u0642\u0645 \u0627\u0644\u0648\u0627\u062A\u0633\u0627\u0628 \u063A\u064A\u0631 \u0645\u0643\u062A\u0645\u0644").max(30),
      email: import_zod2.z.string().trim().email("\u0627\u0644\u0628\u0631\u064A\u062F \u0627\u0644\u0625\u0644\u0643\u062A\u0631\u0648\u0646\u064A \u063A\u064A\u0631 \u0635\u0627\u0644\u062D").optional().or(import_zod2.z.literal("")),
      message: import_zod2.z.string().trim().min(10, "\u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u064A\u062C\u0628 \u0623\u0646 \u062A\u062D\u062A\u0648\u064A \u0639\u0644\u0649 10 \u0623\u062D\u0631\u0641 \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644").max(2e3)
    })).mutation(async ({ input }) => {
  ...
  vehicleRequests: router({
    broadcast: protectedProcedure.input(import_zod2.z.object({
      city: import_zod2.z.string().trim().max(100).optional(),
      brand: import_zod2.z.string().trim().max(100).optional(),
      bodyType: import_zod2.z.string().trim().max(80).optional(),
      models: import_zod2.z.array(import_zod2.z.string().trim().min(1).max(100)).max(8).default([]),
      trim: import_zod2.z.string().trim().max(100).optional(),
      condition: import_zod2.z.enum(["new", "used"]).optional(),
      minPrice: import_zod2.z.number().positive().optional(),
      maxPrice: import_zod2.z.number().positive().optional(),
      targetPrice: import_zod2.z.number().positive().optional(),
      minYear: import_zod2.z.number().int().min(1980).max(2100).optional(),
      message: import_zod2.z.string().trim().min(10).max(2e3)
...
${details}`
  ...
  dashboard: router({
    ...
    analytics: protectedProcedure.input(import_zod2.z.object({ days: import_zod2.z.number().min(7).max(90).default(30) })).query(async ({ input, ctx }) => {
      const dealer = await getDealerByUserId(ctx.user.id);
      if (!dealer) return { daily: [], totals: { views: 0, inquiries: 0, vehicleViews: 0 } };
      return getDealerAnalytics(dealer.id, input.days);
    }),
    stats: protectedProcedure.input(import_zod2.z.object({ dealerId: import_zod2.z.number() })).query(async ({ input, ctx }) => {
      await requireDealerAccess(ctx.user, input.dealerId);
      return getDealerDashboard(input.dealerId);
    }),
    myVehicles: protectedProcedure.input(import_zod2.z.object({ dealerId: import_zod2.z.number() })).query(async ({ input, ctx }) => {
      await requireDealerAccess(ctx.user, input.dealerId);
      return getVehicles({ dealerId: input.dealerId, limit: 100, offset: 0 });
    }),
    myInquiries: protectedProcedure.input(import_zod2.z.object({ dealerId: import_zod2.z.number() })).query(async ({ input, ctx }) => {
      await requireDealerAccess(ctx.user, input.dealerId);
      return getInquiriesByDealer(input.dealerId);
    }),
    updateDealer: protectedProcedure.input(import_zod2.z.object({
      dealerId: import_zod2.z.number(),
      ...
      workingHours: import_zod2.z.string().optional(),
      workingHoursDetail: import_zod2.z.string().optional(),
      logo: import_zod2.z.string().optional(),
      cover: import_zod2.z.string().optional(),
      lat: import_zod2.z.number().optional(),
      lng: import_zod2.z.number().optional(),
      instagram: import_zod2.z.string().optional(),
      twitter: import_zod2.z.string().optional(),
      snapchat: import_zod2.z.string().optional(),
      tiktok: import_zod2.z.string().optional(),
      website: import_zod2.z.string().optional(),
      brands: import_zod2.z.string().optional(),
      city: import_zod2.z.string().optional(),
      neighborhood: import_zod2.z.string().optional(),
      dealerType: import_zod2.z.enum(["sell", "buy", "both"]).optional()
    })).mutation(async ({ input, ctx }) => {
  ...
  admin: router({
    ...
    verifyDealer: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number(), isVerified: import_zod2.z.boolean() })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
      await verifyDealer(input.id, input.isVerified);
      return { success: true };
    }),
    updateDealerStatus: protectedProcedure.input(import_zod2.z.object({
      id: import_zod2.z.number(),
      status: import_zod2.z.enum(["pending", "active", "suspended", "rejected"]),
    ...
    grantDemoDealerAccount: protectedProcedure.input(import_zod2.z.object({
      dealerId: import_zod2.z.number().int().positive(),
      email: import_zod2.z.string().trim().email().max(320),
      password: import_zod2.z.string().min(ENV.isProduction ? 12 : 8).max(100)
    })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
      ...
      if (!owner) {
        const passwordHash = await (0, import_bcryptjs3.hash)(input.password, ENV.passwordHashRounds);
    ...
    updatePlan: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number(), plan: import_zod2.z.enum(["free", "basic", "pro", "premium"]) })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
      await updateDealerPlan(input.id, input.plan);
      return { success: true };
    }),
    deleteDealer: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number() })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
    ...
    updateUserRole: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number(), role: import_zod2.z.enum(["user", "admin"]) })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
    ...
    updateContactStatus: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number(), status: import_zod2.z.enum(["new", "read", "replied"]) })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
    ...
    deleteReview: protectedProcedure.input(import_zod2.z.object({ id: import_zod2.z.number() })).mutation(async ({ input, ctx }) => {
      if (ctx.user.role !== "admin") throw new Error("Forbidden");
  ...
  notifications: router({
    ...
    markRead: protectedProcedure.input(import_zod2.z.object({ ids: import_zod2.z.array(import_zod2.z.number()).optional() })).mutation(async ({ input, ctx }) => {
...
// server/upload.ts
var uploadRouter = (0, import_express.Router)();
var multipartUpload = (0, import_multer.default)({
...
function createApp() {
  ...
  app2.use(import_express2.default.json({ limit: "1mb" }));
  app2.use(import_express2.default.urlencoded({ limit: "1mb", extended: true }));
